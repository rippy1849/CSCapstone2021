...
while(True):
    ...
    for k,image in enumerate(mp):
        ...
        boxes, weights = hog.detectMultiScale(image, padding=(4, 4), scale=1.05)
        #print(weights)
    ...
    if time.time() - pantime > 0.01 and human == True:
        
        
        
        
        #print(xavg)
        if xavg < posx-xthresh:
            #print("LEFT")
            s1 = (posx-xthresh)-xavg
